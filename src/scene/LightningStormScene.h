...
namespace nhahn
{
	class LightningStormScene : public Scene
	{
	public:
		LightningStormScene(std::string name) : Scene(name) {}
		virtual ~LightningStormScene() {}
	...
	private:
		std::unique_ptr<Shader> _lightningStormProg;
